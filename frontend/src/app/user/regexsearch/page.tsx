...
const RegexSearch: React.FC = () => {
    ...
    const handleSearch = async () => {
        setLoading(true);
        let response = await fetch("http://127.0.0.1:5000/search-regex", {
            method: "POST",
            headers: {
    ...
    // debouncing in 500ms to avoid multiple API calls using useEffect
        ...
        <div className="flex h-screen bg-gray-100 dark:bg-gray-900">
            ...
            <div className="flex-1 flex flex-col overflow-hidden">
                ...
                <div className="flex-1 overflow-auto p-6">
                    <Card className="mb-6">
                        <CardHeader>
                            <CardTitle className="text-xl">Search for Regex Patterns</CardTitle>
                        </CardHeader>
                        <CardContent>
                            <Input
                    ...
                    {loading && (
                        <div
                            role="status"
                            className="flex items-center justify-center h-96 text-gray-400 dark:text-gray-600 dark:bg-gray-800 bg-gray-100 gap-6"
                        >
                            <svg
                                aria-hidden="true"
